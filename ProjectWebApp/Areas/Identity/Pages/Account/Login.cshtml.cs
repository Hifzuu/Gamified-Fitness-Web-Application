...
namespace ProjectWebApp.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            public bool RememberMeToggle { get; set; }
        }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var result = await _signInManager.PasswordSignInAsync(Input.CustomUserName, Input.Password, Input.RememberMeToggle, lockoutOnFailure: false);
                if (result.Succeeded)
                {
                ...
                {
                    return RedirectToPage("./LoginWith2fa", new { ReturnUrl = returnUrl, RememberMe = Input.RememberMeToggle });
                }
